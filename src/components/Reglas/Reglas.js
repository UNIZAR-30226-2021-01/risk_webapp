		...
		<MDBContainer className="container-fondo-reglas">
			<MDBContainer className="container-reglas">
				...
				<p className="text-left">
					En este juego participan entre 3 y 6 jugadores en un mapa global con
					el objetivo de conquistar el mundo entero usando tropas para atacar y
				...
				<p>
					...
					territorio enemigo tantas veces como quieras. No puedes atacar desde
					un territorio que sólo tenga una tropa.
				</p>
				<h2>
					<strong>Fase 3: </strong>
				</h2>
				<p>
					Una única vez, mueve un número cualquiera de tropas desde un
					territorio controlado por tí a otro territorio de tu propiedad.
				</p>
			</MDBContainer>
		</MDBContainer>
	)
